...
public class ContentExtractor {
	...
	public String extractFromDocument(Page page){
	 ...
	 public String getPlainText(Element element) throws BoilerpipeProcessingException {



	        return ArticleExtractor.getInstance().getText(element.html().toString()).replaceAll("[\\n\\t ]", " ");
	    }
